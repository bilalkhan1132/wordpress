...
function default_settings_themes(){
  	...
  	//Featured Slider
		$default_setting['featured_slider_arrow_bg_color']='#009dea';
		$default_setting['featured_slider_arrow_texthover_color']='#009dea';
	...
	//Featured Section
		...
		$default_setting['featured_section_bg_hover_color']='#009dea';
	    $default_setting['featured_section_text_hover_color']='#ffffff';
	    $default_setting['featured_section_icon_color']='#ffffff';
	    $default_setting['featured_section_icon_hover_color']='#009dea';
	    $default_setting['featured_section_icon_bg_color']='#009dea';
	...
	//About Us
	    ...
	    $default_setting['about_link_color']='#009dea';
	...
	//Our Portfolio Section
    	...
    	$default_setting['our_portfolio_icon_bg_color']='#009dea';
    ...
    //Our Services Section
    	...
    	$default_setting['our_services_icon_color']='#009dea';
    	$default_setting['our_services_icon_hover_color']='#ffffff';
    	$default_setting['our_services_contain_bg_hover_color']='#009dea';
    ...
    //Our Team Section
	    ...
	    $default_setting['our_team_icon_hover_color']='#fff';
	    $default_setting['our_team_icon_background_color']='#009dea';
	    $default_setting['our_team_icon_bg_hover_color']='#122f54';
	...
	//Our Testimonial Section
	    ...
	    $default_setting['our_team_testimonial_arrow_bg_color']='#009dea';
	...
	//Our Sponsors Section
	    ...
	    $default_setting['our_sponsors_arrow_bg_color']='#009dea';
}